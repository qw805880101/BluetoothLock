...
public class LockInfo implements Serializable{
    ...
    public String getLockBluetoothMac() {
        return lockBluetoothMac;
    }

    public void setLockBluetoothMac(String lockBluetoothMac) {
        this.lockBluetoothMac = lockBluetoothMac;
    }
    ...
    public String getLockSeries() {
        return lockSeries;
    }

    public void setLockSeries(String lockSeries) {
