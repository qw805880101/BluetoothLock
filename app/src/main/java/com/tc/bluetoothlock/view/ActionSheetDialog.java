...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog builder() {
        ...
        txt_takePhoto.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                mClickListener.onClick(TAKE_PHOTO);
            }
        });
        txt_takeFile = (TextView) view.findViewById(R.id.txt_choosePhoto);
        txt_takeFile.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                mClickListener.onClick(TAKE_FILE);
            }
        });
