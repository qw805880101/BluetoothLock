...
public class RxService {
    ...
    public static <T> T createDecodeApi(Class<T> clazz) {
        return createDecodeApi(clazz, WRCoreApp.getInstance().setBaseUrl());
    }

    public static <T> T createDecodeApi(Class<T> clazz, String url) {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(url)
                .client(okHttpClient)
                .addCallAdapterFactory(RxJavaCallAdapterFactory.create())
